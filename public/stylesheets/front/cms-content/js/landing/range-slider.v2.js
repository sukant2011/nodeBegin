    ...
    (function($, window) {
      ...
      SimpleSlider = (function() {
        ...
        function SimpleSlider(input, options) {
          ...
          this.input.hide();
          this.slider = $("<div>").addClass("slider" + (this.settings.classSuffix || ""))
          .css({
            position: "relative",
            userSelect: "none",
          ...
          if (this.settings.highlight) {
            ...
            if (this.settings.highlightColor) {
              this.highlightTrack.addClass("highlight-track--green");
            }
          }
          this.dragger = this.createDivElement("dragger");
          if (this.settings.highlightColor) {
            this.dragger.addClass("dragger--green");
          } else {
            this.dragger.addClass("dragger--purple");
          }
          this.slider.css({
      ...
      return $(function() {
        return $("[data-slider]").each(function() {
          ...
          if ($el.data("slider-highlight-color")) {
            settings.highlightColor = $el.data("slider-highlight-color");
          }
